        ...
        <div className="flex flex-col gap-10 my-20 px-2 m-auto max-w-2xl">
            ...
            <div className="flex flex-col gap-3">
                ...
                <ul className="list-inside list-disc">
                    ...
                    <li>Backspace: delete the recent selected item if the search term is empty</li>
                </ul>
                <h4 className="font-bold">Mouse Events</h4>
                <ul className="list-inside list-disc">
                    <li>Clicking outside the selector will close the options list</li>
                </ul>
            </div>
        </div>
